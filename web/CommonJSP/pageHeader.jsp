                                        ...
                                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">  <div class="profile image">
                                                <%
                                                    if ("Student".equalsIgnoreCase(session.getAttribute("uType").toString())) {
                                                        con.read("SELECT TO_BASE64(sp.photo) photo FROM student_photo sp WHERE sp.student_id='" + session.getAttribute("ss_id") + "' AND sp.status=1 ");
                                                    } else {
                                                        con.read("SELECT TO_BASE64(sp.photo) photo FROM staff_photo sp WHERE sp.staff_id='" + session.getAttribute("ss_id") + "' AND sp.status=1 ");
                                                    }
